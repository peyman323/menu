...
var Outlet = exports.Outlet = (function () {
  ...
  (0, _createClass3.default)(Outlet, [{
    key: 'runHooks',
    value: (function () {
      var ref = (0, _bluebird.coroutine)(_regenerator2.default.mark(function _callee(stage, name) {
      ...
      return function runHooks(_x2, _x3, _x4) {
    ...
    value: function addHook(stage, _ref) {
      ...
      var callbackName = fn && fn.name || 'anon' + (0, _uniqueid2.default)();
    ...
    key: 'perform',
    value: (function () {
      var ref = (0, _bluebird.coroutine)(_regenerator2.default.mark(function _callee2(name, opts, fn) {
        var callInfo;
    ...
    key: '_perform',
    value: (function () {
      var ref = (0, _bluebird.coroutine)(_regenerator2.default.mark(function _callee3(name, opts, fn) {
      ...
      return function _perform(_x9, _x10, _x11) {
        return ref.apply(this, arguments);
      };
    })()
