...
describe('Outlet', function () {
  ...
  it('callbacks fire in the correct order', function (done) {
    ...
    outlet.before('foo', (0, _bluebird.coroutine)(_regenerator2.default.mark(function _callee() {
    ...
    outlet.before('foo', (0, _bluebird.coroutine)(_regenerator2.default.mark(function _callee2() {
    ...
    outlet.after('foo', (0, _bluebird.coroutine)(_regenerator2.default.mark(function _callee3() {
    ...
    outlet.after('foo', (0, _bluebird.coroutine)(_regenerator2.default.mark(function _callee4() {
    ...
    event.run({}, (0, _bluebird.coroutine)(_regenerator2.default.mark(function _callee5() {
  ...
  it('callbacks fire in correct order when manually ordered', function (done) {
    ...
    var bar1 = outlet.event('bar1', (0, _bluebird.coroutine)(_regenerator2.default.mark(function _callee6() {
    ...
    var bar2 = outlet.event('bar2', (0, _bluebird.coroutine)(_regenerator2.default.mark(function _callee7() {
    ...
    event.run({}, (0, _bluebird.coroutine)(_regenerator2.default.mark(function _callee8() {
